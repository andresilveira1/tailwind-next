        ...
        >
          <div className="flex flex-col gap-3 lg:grid lg:grid-cols-form">
            ...
            <div className="flex flex-col gap-6 lg:grid lg:grid-cols-2">
              <Input.Root>
                <Input.Control id="firstName" defaultValue="André" />
              </Input.Root>
              ...
              <div className="flex flex-col gap-3 lg:block">
                ...
                <Input.Root>
                  <Input.Control id="lastName" defaultValue="Silveira" />
                </Input.Root>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            ...
            <Input.Root>
              ...
              <Input.Control
                id="email"
                type="email"
                defaultValue="andre.silveira1silva@gmail.com"
              />
            </Input.Root>
          </div>
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            ...
            <Input.Root>
              <Input.Control id="role" defaultValue="Developer FullStack" />
            </Input.Root>
          </div>
            ...
            <div className="space-y-3">
              <div className="flex flex-col gap-3 lg:grid lg:grid-cols-2">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <Button type="button" variant="ghost">
                    <Link2 className="h-5 w-5 text-zinc-500" strokeWidth={3} />
                  </Button>
              ...
              <Textarea
                id="bio"
                defaultValue="I'm a Developer FullStack based in Espírito Santo, Brazil. I work with ReactJS and NodeJS."
              />
            </div>
          </div>
