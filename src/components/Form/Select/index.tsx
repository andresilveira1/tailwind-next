    ...
    <SelectPrimitive.Root {...props}>
      ...
      <SelectPrimitive.Portal>
        <SelectPrimitive.Content
          ...
          position="popper"
          sideOffset={8}
          className="boder-zinc-200 z-10 w-[--radix-select-trigger-width] animate-slideDownAndFade overflow-hidden rounded-lg border bg-white shadow-sm dark:border-zinc-700 dark:bg-zinc-800"
        >
